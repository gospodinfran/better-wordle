      ...
      <div className="flex flex-col gap-[5px] md:gap-2 justify-center my-2">
          ...
          {firstRow.map((letter, index) => {
            ...
            return (
              <Draggable
                ...
                classes={`flex justify-center items-center md:text-xl ${
                  darkTheme ? '' : 'border-2  border-gray-300'
                } rounded md:rounded-md p-0 w-[8.5vw] h-[11vw] md:w-12 md:h-[60px] hover:cursor-pointer select-none touch-none ${
                  color === 'green'
                    ? 'bg-green-600'
                    : color === 'yellow'
                    ? 'bg-yellow-500'
        ...
        <div className="flex justify-center gap-[5px] md:gap-2">
          <div
            ...
            className={`flex justify-center items-center font-medium text-sm ${
              darkTheme ? '' : 'border-2  border-gray-300'
            }rounded md:rounded-md p-0 w-[12vw] h-[11vw] md:w-[68px] md:h-[60px] hover:cursor-pointer select-none bg-[#ededed]`}
          >
            ENTER
          </div>
