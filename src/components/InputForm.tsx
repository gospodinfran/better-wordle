export default function InputForm({ value, onChange, onSubmit }: { value: any, onChange: (e: any) => void, onSubmit: any }) {
    ...
    return(
        <form onSubmit={onSubmit} className="mt-16 flex justify-center">
            <input type="text" value={value} className="block w-52 rounded-md border-0 py-3 px-5 text-gray-900 ring-1 
